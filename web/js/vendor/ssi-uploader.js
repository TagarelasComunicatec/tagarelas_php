...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
		 pt_br: {
	            success: 'Sucesso',
	            sucUpload: 'Upload realidado com sucesso',
	            chooseFiles: 'Escolha arquivo(s)',
	            ...
	            sizeError: '$1 excede o limite de $2 Kb',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
	            extError: '$1 Este tipo de arquivo não é permitido',//$1=file extension ie(exe files are not supported)
	            someErrorsOccurred: 'Ocorreram alguns erros',
	            wentWrong: 'Algo parece estar errado!',
	            pending: 'Pedente',
	            completed: 'Concluido',
